...
public class PayFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        events.add(new PayFragment.Event(R.drawable.profile_image1, "바보 동아리", "5차 정모", "2023년 5월 17일 20시", "노원역", 25000, 0));
        events.add(new PayFragment.Event(R.drawable.profile_image2, "가천 동아리", "번개모임", "2023년 5월 18일 14시", "가천대역", 20000, 0));
        events.add(new PayFragment.Event(R.drawable.profile_image3, "바보 동아리", "6차 정모", "2023년 5월 20일 17시", "창동역", 30000, 0));
